...
# Unit tests for Wire4Client::SpidBeneficiaryResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SpidBeneficiaryResponse' do
  before do
    # run before each test
    @instance = Wire4Client::SpidBeneficiaryResponse.new
  end
  ...
  describe 'test an instance of SpidBeneficiaryResponse' do
    it 'should create an instance of SpidBeneficiaryResponse' do
      expect(@instance).to be_instance_of(Wire4Client::SpidBeneficiaryResponse)
    end
  end
