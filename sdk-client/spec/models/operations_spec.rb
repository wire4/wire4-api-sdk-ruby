...
# Unit tests for Wire4Client::Operations
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Operations' do
  before do
    # run before each test
    @instance = Wire4Client::Operations.new
  end
  ...
  describe 'test an instance of Operations' do
    it 'should create an instance of Operations' do
      expect(@instance).to be_instance_of(Wire4Client::Operations)
    end
  end
  ...
  describe 'test attribute "sales_point"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
