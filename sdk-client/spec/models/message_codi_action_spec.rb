...
# Unit tests for Wire4Client::MessageCodiAction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MessageCodiAction' do
  before do
    # run before each test
    @instance = Wire4Client::MessageCodiAction.new
  end
  ...
  describe 'test an instance of MessageCodiAction' do
    it 'should create an instance of MessageCodiAction' do
      expect(@instance).to be_instance_of(Wire4Client::MessageCodiAction)
    end
  end
  ...
  describe 'test attribute "sales_point_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
