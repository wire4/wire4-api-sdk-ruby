...
# Unit tests for Wire4Client::MessagePayment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MessagePayment' do
  before do
    # run before each test
    @instance = Wire4Client::MessagePayment.new
  end
  ...
  describe 'test an instance of MessagePayment' do
    it 'should create an instance of MessagePayment' do
      expect(@instance).to be_instance_of(Wire4Client::MessagePayment)
    end
  end
