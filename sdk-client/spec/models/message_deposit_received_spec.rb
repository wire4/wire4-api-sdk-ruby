...
# Unit tests for Wire4Client::MessageDepositReceived
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MessageDepositReceived' do
  before do
    # run before each test
    @instance = Wire4Client::MessageDepositReceived.new
  end
  ...
  describe 'test an instance of MessageDepositReceived' do
    it 'should create an instance of MessageDepositReceived' do
      expect(@instance).to be_instance_of(Wire4Client::MessageDepositReceived)
    end
  end
