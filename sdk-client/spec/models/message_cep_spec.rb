...
# Unit tests for Wire4Client::MessageCEP
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MessageCEP' do
  before do
    # run before each test
    @instance = Wire4Client::MessageCEP.new
  end
  ...
  describe 'test an instance of MessageCEP' do
    it 'should create an instance of MessageCEP' do
      expect(@instance).to be_instance_of(Wire4Client::MessageCEP)
    end
  end
  ...
  describe 'test attribute "bank_sender"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
