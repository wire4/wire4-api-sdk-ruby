...
module Wire4Client
  ...
  class GetDepositants
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'depositants')
        if (value = attributes[:'depositants']).is_a?(Array)
          self.depositants = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @depositants.nil?
        invalid_properties.push('invalid value for "depositants", depositants cannot be nil.')
      end
    ...
    def valid?
      return false if @depositants.nil?
      true
    end
