...
module Wire4Client
  ...
  class UserCompany
    ...
    attr_accessor :surname_father

    # El apellido materno del usuario
    attr_accessor :surname_mother
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'legal_representative')
        self.legal_representative = attributes[:'legal_representative']
      end
      ...
      if attributes.has_key?(:'surname_father')
        self.surname_father = attributes[:'surname_father']
      end

      if attributes.has_key?(:'surname_mother')
        self.surname_mother = attributes[:'surname_mother']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          surname_father == o.surname_father &&
          surname_mother == o.surname_mother &&
    ...
    def hash
      [emails, legal_representative, masked_name, masked_user_name, name, phone_numbers, surname_father, surname_mother, user_name].hash
    end
