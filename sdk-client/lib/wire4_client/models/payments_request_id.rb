...
module Wire4Client
  class PaymentsRequestId
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'total_transactions')
    ...
    def hash
      [authorization_date, request_date, request_id, total_amount, total_transactions, transactions].hash
    end
