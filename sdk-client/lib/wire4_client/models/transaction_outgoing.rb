...
module Wire4Client
  ...
  class TransactionOutgoing
    ...
    # Cuenta a la que se quiere hacer la transferencia
    ...
    def hash
      [amount, beneficiary, beneficiary_account, beneficiary_bank_key, concept, currency_code, email, order_id, reference].hash
    end
