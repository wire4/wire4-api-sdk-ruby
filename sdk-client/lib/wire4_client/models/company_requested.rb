...
module Wire4Client
  ...
  class CompanyRequested
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'comercial_name')
        self.comercial_name = attributes[:'comercial_name']
      end
    ...
    def hash
      [business_name, certificate, comercial_name, rfc].hash
    end
