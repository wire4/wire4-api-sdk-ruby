...
module Wire4Client
  ...
  class PaymentRequestCodiResponseDTO
    ...
    def self.swagger_types
      {
        ...
        :'operations' => :'Array<PaymentRequestCodiResponseDTO>',
        :'order_id' => :'String',
        :'payment_type' => :'String',
        :'phone_number' => :'String',
        :'status' => :'String',
    ...
    def hash
      [amount, barcode_base64, barcode_url, concept, creation_date, due_date, id, operation_date, operations, order_id, payment_type, phone_number, status, transaction_id, type].hash
    end
