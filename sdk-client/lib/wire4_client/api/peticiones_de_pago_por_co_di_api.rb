...
module Wire4Client
  class PeticionesDePagoPorCoDiApi
    ...
    def consult_codi_request_by_order_id_with_http_info(authorization, order_id, sales_point_id, opts = {})
      ...
      # resource path
      local_var_path = '/codi/sales-point/{sales_point_id}/charges/{order_id}'.sub('{' + 'order_id' + '}', order_id.to_s).sub('{' + 'sales_point_id' + '}', sales_point_id.to_s)
    ...
    def generate_codi_code_qr_with_http_info(authorization, codi_info, sales_point_id, opts = {})
      ...
      # resource path
      local_var_path = '/codi/sales-point/{salesPointId}/charges'.sub('{' + 'salesPointId' + '}', sales_point_id.to_s)
