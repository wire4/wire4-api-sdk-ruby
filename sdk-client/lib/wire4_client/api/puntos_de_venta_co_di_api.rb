...
module Wire4Client
  class PuntosDeVentaCoDiApi
    ...
    # @param sales_point_request salesPointRequest
    # @param [Hash] opts the optional parameters
    # @option opts [String] :name 
    # @return [SalesPointRespose]
    def create_sales_point(authorization, company_id, sales_point_request, opts = {})
      data, _status_code, _headers = create_sales_point_with_http_info(authorization, company_id, sales_point_request, opts)
      data
    end
    ...
    def create_sales_point_with_http_info(authorization, company_id, sales_point_request, opts = {})
      ...
      # verify the required parameter 'sales_point_request' is set
      if @api_client.config.client_side_validation && sales_point_request.nil?
        fail ArgumentError, "Missing the required parameter 'sales_point_request' when calling PuntosDeVentaCoDiApi.create_sales_point"
      end
      # resource path
      local_var_path = '/codi/companies/{company_id}/salespoint'.sub('{' + 'company_id' + '}', company_id.to_s)
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(sales_point_request)
      auth_names = []
