...
module Wire4Client
  class TransferenciasSPEIApi
    ...
    def out_comming_spei_request_id_transactions_report_using_get(request_id, subscription, opts = {})
      data, _status_code, _headers = out_comming_spei_request_id_transactions_report_using_get_with_http_info(request_id, subscription, opts)
      data
    end
    ...
    def out_comming_spei_request_id_transactions_report_using_get_with_http_info(request_id, subscription, opts = {})
      if @api_client.config.debugging
